  ...
  <div className="flex flex-col gap-8 items-center p-8 rounded-2xl bg-primary-container/10 border border-outline-variant shadow-2xl max-w-2xl mx-auto backdrop-blur-md">
      ...
      <div className="flex gap-6 w-full max-w-md">
        ...
        <button 
          ...
          className="flex-1 flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl text-sm font-bold uppercase tracking-wide text-black bg-primary hover:bg-[#97f284] active:scale-95 shadow-[0_4px_20px_rgba(130,219,111,0.25)] hover:shadow-[0_4px_25px_rgba(130,219,111,0.4.5)] transition-all duration-150 cursor-pointer"
        >
        ...
        <button 
          ...
          className="flex-1 flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl text-sm font-bold uppercase tracking-wide text-[#5e1811] bg-secondary hover:bg-[#ffc7c1] active:scale-95 shadow-[0_4px_20px_rgba(255,180,172,0.15)] hover:shadow-[0_4px_25px_rgba(255,180,172,0.3)] transition-all duration-150 cursor-pointer"
        >
